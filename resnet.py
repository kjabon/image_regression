...
class ResNet(hk.Module):
  ...
  CONFIGS = {
      ...
      8: {
          "blocks_per_group": (1, 1, 1),
          "bottleneck": False,
          "channels_per_group": (32, 64, 128),
  ...
  def __init__(
    ...
    check_length(len(strides), blocks_per_group, "blocks_per_group")
    check_length(len(strides), channels_per_group, "channels_per_group")
    # check_length(4, strides, "strides")

    initial_conv_config = dict(initial_conv_config or {})
    initial_conv_config.setdefault("output_channels", min(64,channels_per_group[0]))
